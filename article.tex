...
{k-\max(j_1,j_2)-2} {\Gamma_{12}} {s_{12}} {T}$. Supposing,
...
The substitution lemma states that if $v_2 \in \relv {k_2}
{\Gamma_{12}} {s_{12}} {T_2}$ and $t \in \rele {k_1} {\Gamma_1
  \envplus{{x_i} : S}} {s_1} T$ and $\Gamma \ts {T_2} \sub S$ with
$\Gamma$ included in $\Gamma_1$ and $\Gamma_{12}$ included in
$\Gamma_1$ and $s_{12}$ included in $s_1$, then $\subst {v_2} {x_i}
{t_i} \in \rele {\min(k_1,k_2)-1} {\Gamma_{12}} {s_{12}} T$.
