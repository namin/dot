...
\Gamma \envplus{y: T_c} \ts \seq{d} \typ \seq{D} \spcomma {t'} \typ {T'}}
...
\begin{multicols}{2}[\judgement{}{\fbox{$\Gamma \ts \seq{d} \typ \seq{D}$}}]

\infrule[\textsc{decls}]
{\Gamma \ts \seq{d_i \typ D_i} \spcomma \seq{S \sub U}}
{\Gamma \ts \seq{d} \typ \seq{D}, \seq{\Ldecl L S U}}
