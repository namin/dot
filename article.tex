...
object-types. \figref{fig:dot-one} gives its syntax, reduction rules,
...
declarations are defined in ~\figref{fig:dot-decls}.
...
The last part of \figref{fig:dot-one} presents rules for type
assignment.  
...
\figref{fig:dot-two} and is further explained below.
...
is well-formed (see \figref{fig:dot-wf} for a definition of
...
in \figref{fig:dot-two}.  Every type declaration $\Ldecl L S U$ in
...
be $\wfe$ (well-formed and expanding; see \figref{fig:dot-wf}), and
...
\boxfig{fig:dot-two}{The DOT Calculus : Membership and Expansion}{
