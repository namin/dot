...
\figref{dot-sub} states that in environment $\Gamma$ the
declaration $D$ subsumes the declaration $D'$. There are two rules,
one for type declarations and one for value declarations.  Rule
...
T'$ if $T$ is a subtype of $T'$.

Declaration subsumption is extended a binary relation between
