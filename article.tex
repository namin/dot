...
of $\Gamma$, so $\Gamma$ can additionaly contain variables not in
...
\begin{proofsketch}
For the monotonicty with regards to the step-index, this follows
...
We thank Amal Ahmed for her many discussions and insights about
applying logical relations to DOT. We thank Donna Malayeri and
Geoffrey Washburn for preliminary work on DOT.
