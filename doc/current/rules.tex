...
\Gamma \envplus{y: T_c};s \ts \seq{S <: U} \spcomma \seq{d \typ D} \spcomma {t'} \approxtyp {T'}}
...
\begin{multicols}{2}[\judgement{Initialization Typing}{\fbox{$\Gamma;s \ts d \typ D$}}]
