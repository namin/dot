...
\end{itemize}
\item translucent sum can be given a more precise type by referring to the name of its type member with a path selection; essential for %example?
\begin{itemize}
...
\begin{itemize}
\item type bindings
\begin{description}[abstract types]
\item[type aliases] $=$
