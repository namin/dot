...
I present three papers~\cite{nuObj,tribe,homl}, each of which models a
...
classes. Virtual classes allows {\it families} of classes to be
...
coming from different families. In Tribe, paths can additionally use
an ``out'' field to refer to the surrounding instance of the prefixed
object.
...
Though Scala doesn't have virtual classes, its abstract types enables
it to emulate some (but not all) of the benefits of virtual classes as
presented in the Tribe calculus.

In terms of theoretical results, there's a sketch of soundness in the
paper, but it's unclear whether it is correct. Decidability and
completeness of subtyping has not yet been established.
