...
signatures in these ML-like module systems. % TODO: develop
...
it means that modules are first-class values. There's a form of
dependent type, since translucent sums are expressions that may
contain types.
...
\subsection{A Nominal Theory of Objects with Dependent Types~\cite{nuObj}}

\subsection{Tribe: a simple virtual class calculus~\cite{tribe}}
