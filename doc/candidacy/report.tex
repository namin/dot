...
translucent signatures, which allows any type to be partially
determined by a type expression.

%Scala's abstract types have close
%resemblances to abstract types of signatures in the module systems of
%ML.
