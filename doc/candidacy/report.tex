...
is explicitly typed, the bindings in class templates can freely refer
to each other (and even to themselves) via $x$, while recall that, in
translucent sums, only later fields can depend on earlier ones.
