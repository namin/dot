...
not native. Note that I tried to emulate ``out'' faithfully, but gave
up and pass the family object to the library methods instead, because
I couldn't make Scala recognize that, for example, \code{e.from.type}
is a subtype of \code{e.out.Node}.
