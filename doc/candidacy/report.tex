...
terms that may contain types. Compared to path-dependent types
...
use an \code{out} field to move from an object to the object which
surrounds it. This \code{out} feature enables ubiquitous access to an
...
mixin composition. In contrast to the three previous calculi,
type-checking in DOT is decidable, since all the judgments are
syntax-directed (in the current design).
