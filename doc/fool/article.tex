...
intermediate term that is not well-typed. We're open to ideas on how
to resolve this. In any case, the standard theorems of preservation
and progress are just one way to prove type safety, which simply
states that a well-typed term cannot be stuck. We are developing a
proof of type safety using logical relations.
