...
is precise and unique, though it doesn't always
exist.
...
We represent it as follows in DOT:
\begin{align*}
\mlnew p {&\Top \mlrefine p {\\
&\ \Ldecl {A_c} \Bot {\Top \refine z {\Ldecl T \Bot {z.A_c}}}\\
&\ \Ldecl {B_c} \Bot {\Top \refine z {\Ldecl T \Bot {z.B_c}}}\\
&}\ldefs{}}{}
\end{align*}
...
What is the expansion of $p.A_c \tand p.B_c$? It is the set ${\Ldecl T
  \Bot {p.A_c \tand p.B_c}}$.
